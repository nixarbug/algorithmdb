...
import com.algorithmdb.service.BlogService;
...
/**
 * REST controller for managing {@link com.algorithmdb.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
public class BlogResource {
     ...
     */
    @GetMapping("/blogs")
    public ResponseEntity<List<Blog>> getAllBlogs(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
