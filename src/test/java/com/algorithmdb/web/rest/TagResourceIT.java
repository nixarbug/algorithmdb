...
import com.algorithmdb.repository.TagRepository;
import com.algorithmdb.service.TagService;
...
public class TagResourceIT {
    ...
    private static final TagType DEFAULT_TYPE = TagType.ALGORITHM;
    private static final TagType UPDATED_TYPE = TagType.BLOG;
