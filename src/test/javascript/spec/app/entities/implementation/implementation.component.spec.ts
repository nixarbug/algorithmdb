...
import { ImplementationComponent } from 'app/entities/implementation/implementation.component';
...
describe('Component Tests', () => {
  describe('Implementation Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ImplementationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.implementations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
