...
import { ProblemGroupComponent } from 'app/entities/problem-group/problem-group.component';
...
describe('Component Tests', () => {
  describe('ProblemGroup Management Component', () => {
    let comp: ProblemGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProblemGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.problemGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
